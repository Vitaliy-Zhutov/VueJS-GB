<template>
    <div class="blog__items" id="app">
        <div v-for="article in articles.slice(0, 3)" class="blog__item">
        ...
        <div v-show="showBlok" class="count__page">
            <div class="count__page-wrap">
                <router-link class="count__page-number" v-for="page in totalPages" :key="`p${page}`"
                    :to="`/blog/${page}`">
